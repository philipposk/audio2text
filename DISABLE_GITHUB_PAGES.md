...
The `CNAME` file in the repository was causing GitHub Pages to claim `mrtranscribe.6x7.gr`, even though you're using Vercel.
...
3. **Remove Custom Domain (if shown):**
   - If there's a "Custom domain" field showing `mrtranscribe.6x7.gr`
...
- Check: `dig mrtranscribe.6x7.gr CNAME +short`
- Should return: `fe052388f074b507.vercel-dns-017.com`

## Why This Happened

- GitHub Pages was enabled for this repository
- The `CNAME` file told GitHub Pages to use `mrtranscribe.6x7.gr`
...
2. `mrtranscribe.6x7.gr` will show your Vercel deployment
