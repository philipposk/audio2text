# DNS Configuration for mrtranscribe.6x7.gr on Papaki

## Current Setup

You have a CNAME record on Papaki:
- **Type**: CNAME
- **Name**: `audio2text` (or `mrtranscribe.6x7.gr`)
...
- **Type**: CNAME
- **Name/Host**: `audio2text` (NOT `mrtranscribe.6x7.gr` - just the subdomain part)
...
- `mrtranscribe.6x7.gr` should resolve to Vercel
